...
SRCS = main.c database.c job.c subs.c strsubs.c chuser.c
OBJS = main.o database.o job.o subs.o strsubs.o chuser.o
TABSRCS = crontab.c strsubs.c chuser.c
TABOBJS = crontab.o strsubs.o chuser.o
PROTOS = protos.h
LIBS =
