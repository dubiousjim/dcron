...
CFLAGS ?= -O2
CFLAGS += -Wall -Wstrict-prototypes -lbsd-compat     -Wextra -Wwrite-strings -Wpointer-arith -O2 -Wpedantic -Wno-missing-field-initializers
SRCS = main.c database.c job.c logging.c utils.c chuser.c
OBJS = main.o database.o job.o logging.o utils.o chuser.o
TABSRCS = crontab.c utils.c chuser.c
